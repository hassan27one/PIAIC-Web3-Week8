...
let usernames = ['Ali', 'Bilal', 'admin', 'Raza', 'Saif'];
...
let describe_city = (city, country = "United States") => {
...
// const mayCar:string = CreateCar("TOYATA", "COROLLA", ["Color","Red"], ["OptionalFailure","SunRoof"], ["Speed","250 KM/h"] );
// console.log(mayCar);
